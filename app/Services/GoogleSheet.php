...
class GoogleSheet
{
    ...
    {
        $this->spreadSheetId = config('peterbitcoin.google_sheet_id');
    ...
    public function readGoogleSheet($lastRow)
    {
        ...
        $data = $this->googleSheetService
            ->spreadsheets_values
            ->batchGet($this->spreadSheetId, ['ranges' => 'Sheet1!A'.$lastRow.':'.$dimensions['colCount']]);
            // Sheet1!A1:D5
            // 'Sheet1!A715:' . $dimensions['colCount']]
